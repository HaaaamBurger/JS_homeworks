...
//
//     const p = document.createElement('p');
//     p.innerText = `${item.age}) ${item.info}`;
//
...
//     duration.innerText = `${item.monthDuration} - ${item.hourDuration}`
//
...
//
//     durationInfo.append(duration);
//
//     mainWrapper.append(h2,durationInfo,modules);
